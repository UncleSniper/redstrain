...
REDSTRAIN_DEPEND_MODULE(Text,
		redbuild, RedStrain/Text, REDSTRAIN_MOD_TEXT, ::redengine::text)
...
REDSTRAIN_DEPEND_MODULE(Locale,
		redbuild, RedStrain/Locale, REDSTRAIN_MOD_LOCALE, ::redengine::locale)
...
REDSTRAIN_DEPEND_MODULE(ProtoStreams,
		redbuild, RedStrain/ProtoStreams, REDSTRAIN_MOD_PROTOSTR, ::redengine::protostr)
