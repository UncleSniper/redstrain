#ifndef REDSTRAIN_TOOLS_CUNT_BLOBDEPEND_HPP
#define REDSTRAIN_TOOLS_CUNT_BLOBDEPEND_HPP
		...
		&& defined(HAVE_REDSTRAIN_LOCALE_CORE_DEPENDENCY) \
		&& defined(HAVE_REDSTRAIN_CMDLINE_L10N_DEPENDENCY) \
...
#endif /* REDSTRAIN_TOOLS_CUNT_BLOBDEPEND_HPP */
