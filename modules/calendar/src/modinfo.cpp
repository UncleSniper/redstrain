...
namespace calendar {
	...
	REDSTRAIN_DEPEND_MODULE(IO,
			RedStrain/Calendar, RedStrain/IO, REDSTRAIN_MOD_IO, ::redengine::io)
	REDSTRAIN_DEPEND_MODULE(Text,
			RedStrain/Calendar, RedStrain/Text, REDSTRAIN_MOD_TEXT, ::redengine::text)
	...
	REDSTRAIN_DEPEND_MODULE(Locale,
			RedStrain/Calendar, RedStrain/Locale, REDSTRAIN_MOD_LOCALE, ::redengine::locale)
	...
	REDSTRAIN_DEPEND_MODULE(ProtoStreams,
			RedStrain/Calendar, RedStrain/ProtoStreams, REDSTRAIN_MOD_PROTOSTR, ::redengine::protostr)
