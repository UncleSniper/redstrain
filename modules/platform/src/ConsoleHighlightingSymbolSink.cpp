...
namespace platform {
	...
	ConsoleHighlightingSymbolSink::HighlightingConfiguration::HighlightingConfiguration()
			...
			constantForeground(Console::MAGENTA), constantBackground(Console::BLACK),
			constantIntensity(Console::NORMAL),
			numberForeground(Console::MAGENTA), numberBackground(Console::BLACK), numberIntensity(Console::NORMAL),
