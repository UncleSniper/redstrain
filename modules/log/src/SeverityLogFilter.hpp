...
namespace log {
	...
	class SeverityLogFilter : public MemberPredicateLogFilter<SeverityT, ComponentT, UnitT, ConcernT, SeverityT> {

	  private:
		typedef MemberPredicateLogFilter<SeverityT, ComponentT, UnitT, ConcernT, SeverityT> Base;
	  ...
	  public:
		SeverityLogFilter(Predicate& predicate, bool managePredicate)
				: MemberPredicateLogFilter<SeverityT, ComponentT, UnitT, ConcernT, SeverityT>(predicate,
				managePredicate) {}

		SeverityLogFilter(const SeverityLogFilter& filter)
				: MemberPredicateLogFilter<SeverityT, ComponentT, UnitT, ConcernT, SeverityT>(filter) {}
