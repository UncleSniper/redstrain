...
namespace log {
	...
	class FilterLogger : public Logger<TimestampT, SeverityT, ComponentT, UnitT, ConcernT> {
	  ...
	  public:
		...
		FilterLogger(const FilterLogger& logger) : Logger<TimestampT, SeverityT, ComponentT, UnitT, ConcernT>(logger),
