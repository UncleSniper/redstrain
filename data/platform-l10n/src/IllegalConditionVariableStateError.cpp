#include <redstrain/platform/IllegalConditionVariableStateError.hpp>
...
namespace platform {
	...
	REDSTRAIN_LOCALIZE_ERROR16(IllegalConditionVariableStateError) {
		...
		out << catalog.formatMessage(
			locale, l10n::MSG_ILLEGAL_CONDITION_VARIABLE_STATE_ERROR,
